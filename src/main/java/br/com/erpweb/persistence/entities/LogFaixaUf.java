...
public class LogFaixaUf implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 5)
    @Column(name = "ufe_rad1_ini")
    private String ufeRad1Ini;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 3)
    @Column(name = "ufe_suf1_ini")
    private String ufeSuf1Ini;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 5)
    @Column(name = "ufe_rad1_fim")
    private String ufeRad1Fim;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 3)
    @Column(name = "ufe_suf1_fim")
    private String ufeSuf1Fim;
    @Size(max = 5)
    @Column(name = "ufe_rad2_ini")
    private String ufeRad2Ini;
    @Size(max = 3)
    @Column(name = "ufe_suf2_ini")
    private String ufeSuf2Ini;
    @Size(max = 5)
    @Column(name = "ufe_rad2_fim")
    private String ufeRad2Fim;
    @Size(max = 3)
    @Column(name = "ufe_suf2_fim")
    private String ufeSuf2Fim;
    @OneToMany(mappedBy = "ufeSg")
    private Collection<LogLocalidade> logLocalidadeCollection;
    ...
    @XmlTransient
    public Collection<LogLocalidade> getLogLocalidadeCollection() {
        return logLocalidadeCollection;
    }

    public void setLogLocalidadeCollection(Collection<LogLocalidade> logLocalidadeCollection) {
        this.logLocalidadeCollection = logLocalidadeCollection;
    }
    ...
    public String toString() {
        return "br.com.erpweb.persistence.entities.LogFaixaUf[ ufeSg=" + ufeSg + " ]";
    }
