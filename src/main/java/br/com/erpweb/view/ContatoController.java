...
import br.com.erpweb.persistence.entities.Contato;
import br.com.erpweb.view.util.JsfUtil;
import br.com.erpweb.view.util.PaginationHelper;
import br.com.erpweb.session.bean.ContatoFacade;
...
public class ContatoController implements Serializable {
    ...
    @EJB private br.com.erpweb.session.bean.ContatoFacade ejbFacade;
