...
import br.com.erpweb.persistence.entities.Fabricante;
import br.com.erpweb.view.util.JsfUtil;
import br.com.erpweb.view.util.PaginationHelper;
import br.com.erpweb.session.bean.FabricanteFacade;
...
public class FabricanteController implements Serializable {
    ...
    @EJB
    private br.com.erpweb.session.bean.FabricanteFacade ejbFacade;
    ...
    public List<Fabricante> getData(){
