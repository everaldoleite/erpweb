...
import br.com.erpweb.session.bean.UsuariosFacade;
...
public class UsuariosController implements Serializable {
    ...
    @EJB
    private br.com.erpweb.session.bean.UsuariosFacade ejbFacade;
    ...
    public String onFlowProcess(FlowEvent event) {
        if (event.getOldStep().equals("dadosBasicos")){
            JsfUtil.addSuccessMessage("Ddssss");
        }
