...
import br.com.erpweb.persistence.entities.ejb.EmpresaFacade;
...
public class EmpresaController implements Serializable {
    ...
    @EJB
    private br.com.erpweb.persistence.entities.ejb.EmpresaFacade ejbFacade;
    ...
    public Empresa getCapturaCep(){
        if (current.getCep().equals("")){
            current.setBairro("");
            ...
            current.setBairro("Cidade Lider");
            current.setLogradouro("Isaar Carlos de Camargo");
            current.setTipoLogradouro("Rua");
            current.setCidade("São Paulo");
            current.setUf("SP");
        }
